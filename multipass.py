'''
The purpose of this module is to explore multipass use of GPT

The code uses a batch of around 100 short-ish philosophy-related posts.

The goal is to write an app that asks questions about the posts by using
multiple calls to GPT to ensure that the answers are truly based on
the texts of these posts.
